...
export default class NewUserStory extends Component {
    ...
    handleSubmit = (event) =>{
        ...
        this.props.agregarUserStory(this.state.titulo, this.state.descripcion, this.state.prioridad, this.state.fechaExpiracion, this.state.fechaCreacion);
    }
        ...
        return (
            <Form onSubmit={this.handleSubmit}>
                ...
                <FormGroup>
                    ...
                    <Input type="datetime"  name="fechaExpiracion" id="fechaExpiracion" placeholder="Fecha de Expiración" value={this.state.fechaExpiracion} onChange={this.handleFechaExpiracionChange}/>
                </FormGroup>
                <FormGroup>
